...
export default async function handler(req, res) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'blaqmamba@mailo.com', // SMTP username
      pass: 'Boy12345', // SMTP password
    },
  });

  // Email options
  let mailOptions = {
    from: '"BLK Report" <blaqmamba@mailo.com>', // Sender address
    to: 'blaqdee@mailo.com', // List of recipients
